                  ...
                  <FadeInSection key={item.alt + idx} delay={idx * 0.1}>
                    <Link href={item.href} className="group block">
                      <div className="flex flex-col items-center">
                        <h2 className="text-xl md:text-2xl font-semibold text-[#676a6c] mb-4 group-hover:text-[var(--brand-blue)] transition-colors">
                          {item.label}
                        </h2>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
                    ...
                    <FadeInSection delay={0.2}>
                      <div>
                        ...
                        <ul className="space-y-2 text-slate-600 font-light text-sm pl-14">
                          <li>
                            <a href="tel:025822110" className="hover:text-[var(--brand-blue)] transition-colors">
                              02-582-2110
                            </a>
                          </li>
                          <li>
                            <a href="tel:0917623838" className="hover:text-[var(--brand-blue)] transition-colors">
                              091-762-3838
                            </a>
                          </li>
                          <li>
                            <a href="tel:0863950364" className="hover:text-[var(--brand-blue)] transition-colors">
                              086-395-0364
                            </a>
                          </li>
                        </ul>
                    ...
                    <FadeInSection delay={0.3}>
                      <div>
                        ...
                        <ul className="space-y-2 text-slate-600 font-light text-sm pl-14">
                          <li>
                            <a href="tel:0831226349" className="hover:text-[var(--brand-blue)] transition-colors">
                              083-122-6349
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="tel:0863213874" className="hover:text-[var(--brand-blue)] transition-colors">
                              086-321-3874
                            </a>
                          </li>
                        </ul>
